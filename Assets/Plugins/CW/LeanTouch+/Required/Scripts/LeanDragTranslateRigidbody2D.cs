...
namespace Lean.Touch
{
	...
	public class LeanDragTranslateRigidbody2D : MonoBehaviour
	{
        ...
        public MMFeedbacks DragFeedback { set { dragFeedback = value; } get { return dragFeedback; } } [SerializeField] private MMFeedbacks dragFeedback;
        public MMFeedbacks DragInactiveFeedback { set { dragInactiveFeedback = value; } get { return dragInactiveFeedback; } }[SerializeField] private MMFeedbacks dragInactiveFeedback;
		...
		protected virtual void Update()
		{
			...
			if (cachedCamera != null)
			{
				...
				else
				{
                    ...
                    if(targetSet)
					{
                        dragInactiveFeedback?.PlayFeedbacks();
                    }
...
namespace Lean.Touch.Editor
{
	...
	public class LeanDragTranslateRigidbody2D_Editor : CwEditor
	{
		protected override void OnInspector()
		{
            ...
            Draw("dragFeedback", "If you want this component to change smoothly over time, then this allows you to control how quick the changes reach their target value.\n\n-1 = Instantly change.\n\n1 = Slowly change.\n\n10 = Quickly change.");
            Draw("dragInactiveFeedback", "If you want this component to change smoothly over time, then this allows you to control how quick the changes reach their target value.\n\n-1 = Instantly change.\n\n1 = Slowly change.\n\n10 = Quickly change.");
        }
	}
}
#endif
...
namespace AgeOfHeroes
{
    ...
    public class UIMessage_B : MonoBehaviour
    {
        public Func<bool> f_Clicked_WatchVideoToUnlock;
        public Func<bool> f_Clicked_UpdateGame;
        public Func<bool> f_Clicked_Buy;
        ...
        void Start()
        {
            switch (m_MessageType)
            {
                case 0:
                    ...
                    m_ButtonPanels[6].gameObject.SetActive(false);
                    break;
                case 1:
                ...
                case 6:
                    ...
                    m_ButtonPanels[4].gameObject.SetActive(false);
                    m_ButtonPanels[5].gameObject.SetActive(false);
                    m_ButtonPanels[6].gameObject.SetActive(true);
                    break;
            }

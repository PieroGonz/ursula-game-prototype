...
namespace AgeOfHeroes
{
    public class UISystem : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            m_Graphics.d_Graphics = new Dictionary<string, Sprite>();
            for (int i = 0; i < m_Graphics.m_Graphics.Length; i++)
            {
                if (!m_Graphics.d_Graphics.ContainsKey(m_Graphics.m_Graphics[i].name))
                {
                    m_Graphics.d_Graphics.Add(m_Graphics.m_Graphics[i].name, m_Graphics.m_Graphics[i]);
                }
            }
        ...
        public static UIMessage_B ShowMessage_B(string msgName, int msgType, string msgText, Sprite msgIcon)
        {
            GameObject uiprefab = FindUIByName(msgName);
            if (uiprefab != null)
            {
                ...
                m_Main.m_LastUI = uiObj;
                m_Main.m_UIStack.Add(uiObj);
                UIMessage_B msg = uiObj.GetComponent<UIMessage_B>();
                msg.m_MessageText.text = msgText;
                msg.m_MessageImage.sprite = msgIcon;
                msg.m_MessageType = msgType;
        ...
        public static UIMessage_C ShowMessage_C(string msgName, int msgType, string msgText, Sprite msgIcon)
        {
            GameObject uiprefab = FindUIByName(msgName);
            if (uiprefab != null)
            {
                ...
                m_Main.m_LastUI = uiObj;
                m_Main.m_UIStack.Add(uiObj);
                UIMessage_C msg = uiObj.GetComponent<UIMessage_C>();
                msg.m_MessageText.text = msgText;
                msg.m_MessageImage.sprite = msgIcon;
                msg.m_MessageType = msgType;
        ...
        public static void ShowStageReward(Sprite icon, string name)
        {
            m_Main.StartCoroutine(Co_ShowStageReward(icon, name));
        }
        ...
        static IEnumerator Co_ShowStageReward(Sprite icon, string name)
        {
            GameObject uiObj = ShowUI("StageRewardUI");
            Image ic = FindImage(uiObj, "StageIcon");
            ic.sprite = icon;
            Text na = FindText(uiObj, "text-name");
            na.text = name;
